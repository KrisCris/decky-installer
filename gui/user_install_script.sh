...
curl -L https://raw.githubusercontent.com/KrisCris/decky-loader/proxy_v3/dist/plugin_loader-${BRANCH}.service  --output ${HOMEBREW_FOLDER}/services/plugin_loader-${BRANCH}.service
